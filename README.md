...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/outdated-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8875&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/outdated-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `outdated` can be installed with:

```
conda install outdated
```

It is possible to list all of the versions of `outdated` available on your platform with:
